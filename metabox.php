<?php
	...
	class LSAP_Metabox {
		...
		static function load_admin_styles(){
			...
			wp_enqueue_script(
				'list-site-and-posts',
				plugins_url( '/js/ms-list-site-and-posts.js' , __FILE__ ),
				array( 'jquery' ),
				'1.0',
				true
			);
			
			wp_enqueue_style( 'list-site-and-posts', plugins_url( '/css/ms-list-sites-and-posts.css' , __FILE__ ) );
		}
		...
		public function add_meta_box( $post_type ) {
			...
			$post_types = apply_filters( 'lsap/cpt_alloweds', array( 'post', 'page' ) );
